function convertToINR()
{
  ...
  var resultspan= document.getElementById("resulttext");
  resultspan.innerText=amount+" "+currency1+" = " +convertedamt.toFixed(2)+" "+currency2;
  resultspan.style.fontSize="25px";
  resultspan.style.marginLeft="18px";
}
